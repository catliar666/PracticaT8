...
public class PlantillaToken {

    public static String generaPlantillaToken(int token){
                return "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                       ...
                       "}\n" +
                       "\n" +
                       "table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_column_2 .v-col-border { border-top: 5px solid #8d95ff !important;border-left: 5px solid #8d95ff !important;border-right: 5px solid #8d95ff !important;border-bottom: 5px solid #8d95ff !important; } #u_content_image_1 .v-container-padding-padding { padding: 20px 10px 10px !important; } #u_content_image_1 .v-src-width { width: auto !important; } #u_content_image_1 .v-src-max-width { max-width: 31% !important; } #u_content_text_2 .v-container-padding-padding { padding: 20px 10px 10px !important; } #u_content_button_1 .v-container-padding-padding { padding: 10px !important; } #u_content_button_1 .v-size-width { width: 65% !important; } #u_content_text_1 .v-container-padding-padding { padding: 10px 10px 40px !important; } #u_content_social_1 .v-container-padding-padding { padding: 40px 10px 10px !important; } #u_content_text_3 .v-container-padding-padding { padding: 10px 10px 20px !important; } #u_content_image_3 .v-container-padding-padding { padding: 20px 10px 40px !important; } }\n" +
                       "    </style>\n" +
                       "  \n" +
                       "  \n" +
                       "\n" +
                       ...
                       "    <p style=\"line-height: 140%;\"><span data-metadata=\"&lt;!--(figmeta)eyJmaWxlS2V5IjoiTHJJMHBSU20xM203UWc0Tk1XZXVQeCIsInBhc3RlSUQiOjE4NjYyMDI5OTgsImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)--&gt;\" style=\"line-height: 19.6px;\"></span><span></span style=\"line-height: 19.6px;\"></span>Querido cliente<br /><br />Recientemente usted ha creado una cuenta en nuestra app, por lo tanto, solo por validación de la misma, le adjuntamos el código verificativo.<br /><br /><strong>Un placer, a partir de ahora quedamos a la espera de la validación.</strong></p>\n" +
                       "  </div>\n" +
                       "\n" +
                       "      </td>\n" +
                       "    </tr>\n" +
                       ...
                       "        \n" +
                       "<div align=\"left\">\n" +
                       "    <a target=\"_blank\" class=\"v-button v-size-width\" style=\"box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #000000; background-color: #ffc25e; border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px; width:42%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;\">\n" +
                       ...
                       "        \n" +
                       "  <div style=\"font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;\">\n" +
                       "    <p style=\"line-height: 140%;\"><span data-metadata=\"&lt;!--(figmeta)eyJmaWxlS2V5IjoiTHJJMHBSU20xM203UWc0Tk1XZXVQeCIsInBhc3RlSUQiOjE4NjYyMDI5OTgsImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)--&gt;\" style=\"line-height: 19.6px;\"></span><span style=\"line-height: 19.6px;\"></span>No olvide validar su cuenta para seguir disfrutando de las ventajas que conlleva haber creado su cuenta con nosotros.<br /><br /><em><strong>Este código no expira.</strong></em></p>\n" +
                       "  </div>\n" +
                       "\n" +
                       "      </td>\n" +
                       "    </tr>\n" +
                       ...
                       "          <img src=\"https://i.ibb.co/bQm40sM/image-4.png\" alt=\"X\" title=\"X\" width=\"32\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important\">\n" +
                       "        </a>\n" +
                       "      </td></tr>\n" +
                       "    </tbody></table>\n" +
                       "\n" +
                       ...
                       "    <p style=\"font-size: 14px; line-height: 170%;\">DARSE DE BAJA   |   POITICAS PRIVACIDAD   |   WEB</p>\n" +
                       "<p style=\"font-size: 14px; line-height: 170%;\"> </p>\n" +
                       "<p style=\"font-size: 14px; line-height: 170%;\">No nos hacemos responsables de las posibles estafas que realicen con nuestra imagen. Tenga cuidado</p>\n" +
                       "  </div>\n" +
                       "\n" +
                       "      </td>\n" +
                       "    </tr>\n" +
